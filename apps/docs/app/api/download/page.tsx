  ...
  return (
    <DocsLayout>
      ...
      <p style={{ fontSize: "1rem", marginBottom: "2rem" }}>
        Download a file by its ID. This endpoint is public — no authentication
        required.
      </p>
        ...
        params={[
          {
            ...
            required: true,
            description:
              "The MongoDB ID of the file returned from the upload endpoint.",
          },
        ]}
...
Content-Length: 278610789`}
      ...
      <h2>Notes</h2>
      <p>
        The download URL never exposes where the file is actually stored. You
        can safely share these URLs publicly.
      </p>
    </DocsLayout>
  );
}
