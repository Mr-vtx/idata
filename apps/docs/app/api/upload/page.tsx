...
export default function UploadDoc() {
  return (
    <DocsLayout>
      ...
      <p style={{ fontSize: "1rem", marginBottom: "2rem" }}>
        Upload any file up to 2GB. Files are stored securely and a download URL
        ...
        body={[
          {
            ...
            type: "File",
            required: true,
            description: "The file to upload. Any format, up to 2GB.",
          },
        ]}
  ...
  "url": "https://api.idata.dev/v1/download/64abc123def456"
      ...
      <h2>Notes</h2>
      <p>
        The returned <code>url</code> is publicly accessible — no authentication
        required to download. Store the <code>fileId</code> in your database to
